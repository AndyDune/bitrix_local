...
$arUrlRewriteLocal = include($_SERVER['DOCUMENT_ROOT'] . "/local/urlrewrite_terms.php");
if (is_array($arUrlRewriteLocal))
{
    foreach($arUrlRewrite as $value)
    {
        $arUrlRewriteLocal[] = $value;
    }
    $arUrlRewrite = $arUrlRewriteLocal;
}
